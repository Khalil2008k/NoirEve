...
export default function WomenPage({
    ...
    // Apply filters
    let filteredWatches = [...womenWatches];
    ...
    if (activeFilters.price?.length) {
        filteredWatches = filteredWatches.filter((w) => {
            ...
            return activeFilters.price.some((range) => {
                ...
                if (range === '500-5000') return price >= 500 && price < 5000;
    ...
    return (
        <>
            ...
            {/* Compact Hero Banner */}
            <section className="relative h-48 sm:h-56 overflow-hidden bg-gradient-to-br from-rose-500/20 via-background to-background">
                ...
                <div className="container-sovereign relative z-10 h-full flex flex-col justify-end pb-6">
                    ...
                    >
                        <p className="text-xs uppercase tracking-[0.3em] text-rose-400 mb-1">
                            Curated for Her
                        </p>
                                ...
                                optionIds.map((optionId) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="flex items-center gap-1.5 px-2.5 py-1 bg-rose-500/20 text-rose-400 text-xs rounded-full hover:bg-rose-500/30 transition-colors"
                                        >
                                            {option?.label}
                                            <X className="h-3 w-3" />
                                        </button>
                    ...
                    <div className="py-6">
                        {paginatedWatches.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-16 text-center">
                                ...
                                <button
                                    onClick={clearAllFilters}
                                    className="px-6 py-2.5 bg-rose-500 text-white text-sm font-bold uppercase tracking-widest rounded-lg hover:scale-105 transition-transform"
                                >
                                    Clear Filters
                                </button>
                            </div>
