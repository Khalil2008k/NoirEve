    ...
    if (activeFilters.price?.length) {
        filteredWatches = filteredWatches.filter((w) => {
            ...
            return activeFilters.price.some((range) => {
                if (range === '0-300') return price < 300;
                if (range === '300-600') return price >= 300 && price < 600;
                if (range === '600-1000') return price >= 600 && price < 1000;
    ...
    return (
        <>
            ...
            <CollectionHero
                ...
                backgroundImage="/images/lifestyle-women.jpg"
                    ...
                    <div className="flex items-center justify-between py-6 border-b border-white/10">
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-sm text-white/50 hidden md:block">
                                Showing {sortedWatches.length} of {womenWatches.length} timepieces
                            </p>
                        </div>
                        <SortDropdown
                            options={sortOptions}
